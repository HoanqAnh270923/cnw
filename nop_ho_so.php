...
if (isset($_GET['id_nghanh'])) {
    $_SESSION['id_nghanh'] = $_GET['id_nghanh'];
}

// Check if id_nghanh exists
                ...
                <div class="form-container">
                    <div class="form-header">
                        <?php
                            ...
                            echo "<h3>" . htmlspecialchars($row['ten_nghanh']) . "</h3>";
                            echo "<h4>Khối xét tuyển: " . htmlspecialchars($row['khoi_xet_tuyen']) . "</h4>";
                            echo "<h4>Ngày kết thúc: " . htmlspecialchars($row['ngay_ket_thuc']) . "</h4>";
